...
var blockchainRID = process.env["BRID"];
console.log("Using NodeID: " + node_id);
console.log("Using BRID: " + blockchainRID);
var nodeApiUrl = "https://rellide-staging.chromia.dev/node/" + node_id + "/";
...
function setToken(id, newName, keys) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function getName(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, gtx.query('get_name', {
                        id: id
                    })];
                case 1:
                    raw = _a.sent();
